...
export default {
  ...
  CHECK_WIKI:
    'Aby uzyskać więcej informacji, sprawdź <a href="${wiki_url}">wiki</a>.',
  ...
  CONVERT_FOLDERS_TO_DECKS_DESC:
    "Jest to alternatywa dla opcji tagów fiszek powyżej.",
  ...
  BURY_SIBLINGS_TILL_NEXT_DAY:
    "Czy ukrywać karty rodzeństwa do następnego dnia?",
  ...
  SHOW_CARD_CONTEXT_DESC:
    "np. Tytuł > Nagłówek 1 > Podnagłówek > ... > Podnagłówek",
  ...
  REVIEW_CARD_ORDER_NEW_FIRST_RANDOM:
    "Losowo w ramach talii (Najpierw wszystkie nowe karty)",
  ...
  CONVERT_HIGHLIGHTS_TO_CLOZES:
    "Konwertować ==podświetlenia== na karty zamaskowane?",
  CONVERT_BOLD_TEXT_TO_CLOZES:
    "Konwertować pogrubiony tekst na karty zamaskowane?",
  CONVERT_CURLY_BRACKETS_TO_CLOZES:
    "Konwertować {{klamry}} na karty zamaskowane?",
  ...
  INLINE_REVERSED_CARDS_SEPARATOR:
    "Separator dla kart zamaskowanych odwróconych w linii",
  ...
  MAX_N_DAYS_REVIEW_QUEUE:
    "Maksymalna liczba dni do wyświetlenia w panelu prawym",
  ...
  MAX_INTERVAL_DESC:
    "Pozwala na ustawienie górnego limitu interwału (domyślnie = 100 lat).",
  ...
  LOGGING: "Logowanie",
  DISPLAY_DEBUG_INFO:
    "Wyświetl informacje debugowania w konsoli deweloperskiej?", // sidebar.ts
