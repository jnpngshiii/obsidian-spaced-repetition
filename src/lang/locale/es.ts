...
export default {
  ...
  STATUS_BAR:
    "Revisar: ${dueNotesCount} nota(s), ${dueFlashcardsCount} tarjetas vencidas",
  SYNC_TIME_TAKEN: "La sincronización tomó ${t} milisegundos",
  NOTE_IN_IGNORED_FOLDER:
    "La nota está guardada en un directorio ignorado (revisa los ajustes).",
  PLEASE_TAG_NOTE:
    "Por favor etiquete apropiadamente la nota para revisión (en los ajustes).",
  ...
  BURY_SIBLINGS_TILL_NEXT_DAY:
    "¿Enterrar tarjetas hermanas hasta el siguiente día?",
  ...
  SHOW_CARD_CONTEXT_DESC:
    "Por Ejemplo: Título > Cabecera > Sub-Cabecera > ... > Sub-Cabecera",
  CARD_MODAL_HEIGHT_PERCENT:
    "Porcentaje de la altura de las tarjetas de memoria",
  ...
  CONVERT_HIGHLIGHTS_TO_CLOZES:
    "¿Convertir ==resaltados== a deletreo de huecos?",
  CONVERT_BOLD_TEXT_TO_CLOZES:
    "¿Convertir **texto en negrita** a deletreo de huecos?",
  CONVERT_CURLY_BRACKETS_TO_CLOZES:
    "¿Convertir {{llaves rizadas}} a deletreo de huecos?",
  ...
  MULTILINE_CARDS_SEPARATOR:
    "Separador para tarjetas de memorización multilínea",
  ...
  AUTO_NEXT_NOTE:
    "Abrir la siguiente nota automáticamente después de una revisión",
  ...
  MAX_N_DAYS_REVIEW_QUEUE:
    "Número máximo de días a mostrar en el panel derecho.",
  ...
  INITIALLY_EXPAND_SUBDECKS_IN_TREE:
    "Los árboles de mazos deberían ser expandidos al inicio.",
