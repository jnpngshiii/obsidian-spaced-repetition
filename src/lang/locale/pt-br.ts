...
export default {
  ...
  NOTE_IN_IGNORED_FOLDER:
    "Nota é salva na pasta ignorada (cheque as configurações).",
  PLEASE_TAG_NOTE:
    "Por favor etiquete a nota apropriadamente para revisar (nas configurações).",
  ...
  SHOW_CARD_CONTEXT_DESC:
    "ex: Título > Cabeçalho 1 > Subcabeçalho > ... > Subcabeçalho",
  ...
  REVIEW_PANE_ON_STARTUP:
    "Habilitar painel de revisão de notas na inicialização",
  ...
  MAX_N_DAYS_REVIEW_QUEUE:
    "Número máximo de dias para exibir no painel direito",
  ...
  LAPSE_INTERVAL_CHANGE_DESC:
    "novoIntervalo = velhoIntervalo * mudancaIntervalo / 100.",
  ...
  LOGGING: "Logging",
  DISPLAY_DEBUG_INFO:
    "Mostrar informação de debugging no console de desenvolvimento?",
