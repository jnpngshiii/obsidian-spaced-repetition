...
export default {
  ...
  CHECK_WIKI:
    'Weitere Informationen gibt es im <a href="${wiki_url}">Wiki</a> (english).',
  ...
  CONVERT_FOLDERS_TO_DECKS_DESC:
    'Eine Alternative zur oberen "Lernkarten Tags" Option.',
  ...
  BURY_SIBLINGS_TILL_NEXT_DAY:
    "Verwandte Karten auf den nächsten Tag verlegen?",
  ...
  SHOW_CARD_CONTEXT_DESC:
    "Bsp. Titel > Überschrift 1 > Sektion > ... > Untersektion",
  ...
  RANDOMIZE_CARD_ORDER:
    "Während der Wiederhoung die Reihenfolge zufällig mischen?",
  ...
  CONVERT_HIGHLIGHTS_TO_CLOZES:
    "==Hervorgehobenen== Text in Lückentextkarten umwandeln?",
  CONVERT_BOLD_TEXT_TO_CLOZES:
    "**Fettgedruckten** Text in Lückentextkarten umwandeln?",
  ...
  INLINE_REVERSED_CARDS_SEPARATOR:
    "Trennzeichen für einzeilige beidseitige Lernkarten",
  MULTILINE_CARDS_SEPARATOR: "Trennzeichen für mehrzeilige Lernkarten",
  MULTILINE_REVERSED_CARDS_SEPARATOR:
    "Trennzeichen für mehrzeilige beidseitige Lernkarten",
  NOTES: "Notizen",
  ...
  AUTO_NEXT_NOTE:
    "Nach einer Wiederholung automatisch die nächste Karte öffnen",
  ...
  INITIALLY_EXPAND_SUBDECKS_IN_TREE:
    "Deckbäume sollten anfänglich erweitert angezeigt werden",
  ...
  LAPSE_INTERVAL_CHANGE_DESC:
    "neuesIntervall = altesIntervall * anpassungsfaktor / 100.",
  ...
  MAX_INTERVAL_MIN_WARNING:
    "Das maximale Interall muss mindestens ein Tag sein.",
  ...
  LOGGING: "Logging",
  DISPLAY_DEBUG_INFO:
    "Informationen zum Debugging in der Entwicklerkonsole anzeigen?",
  ...
  COUNT: "Anzahl",
  INTERVALS_SUMMARY:
    "Durchschnittliches Intervall: ${avg}, Längstes Intervall: ${longest}",
  EASES: "Einfachheit",
