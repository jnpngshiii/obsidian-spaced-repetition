...
export function upgradeSettings(settings: SRSettings) {
  if (
    ...
    console.log(
      `loadPluginData: Upgrading settings: ${settings.randomizeCardOrder}`,
    );
...
export class SRSettingTab extends PluginSettingTab {
  ...
  display(): void {
    ...
    const deckOrderEnabled: boolean =
      this.plugin.data.settings.flashcardCardOrder !=
        "EveryCardRandomDeckAndCard";
    new Setting(this.containerEl).setName(t("REVIEW_DECK_ORDER")).addDropdown((
      dropdown,
    ) =>
      dropdown
        .addOptions(
    ...
    new Setting(containerEl).setName(t("CONVERT_HIGHLIGHTS_TO_CLOZES"))
      .addToggle((toggle) =>
        toggle
    ...
    new Setting(containerEl).setName(t("CONVERT_BOLD_TEXT_TO_CLOZES"))
      .addToggle((toggle) =>
        toggle
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text.setValue(this.plugin.data.settings.flashcardEasyText).onChange(
          (value) => {
            applySettingsUpdate(async () => {
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text.setValue(this.plugin.data.settings.flashcardGoodText).onChange(
          (value) => {
            applySettingsUpdate(async () => {
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text.setValue(this.plugin.data.settings.flashcardHardText).onChange(
          (value) => {
            applySettingsUpdate(async () => {
    ...
    new Setting(containerEl).setName(t("REVIEW_PANE_ON_STARTUP")).addToggle((
      toggle,
    ) =>
      toggle
    ...
    new Setting(containerEl).setName(t("AUTO_NEXT_NOTE")).addToggle((toggle) =>
      toggle.setValue(this.plugin.data.settings.autoNextNote).onChange(
        async (value) => {
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text.setValue(this.plugin.data.settings.baseEase.toString()).onChange(
          (value) => {
            applySettingsUpdate(async () => {
              const numValue: number = Number.parseInt(value);
              if (!isNaN(numValue)) {
    ...
    new Setting(containerEl).setName(t("DISPLAY_DEBUG_INFO")).addToggle((
      toggle,
    ) =>
      toggle.setValue(this.plugin.data.settings.showDebugMessages).onChange(
        async (value) => {
